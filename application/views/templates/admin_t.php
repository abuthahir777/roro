...
<html lang="en">
  ...
  <body>
      ...
      <nav class="bottom-navbar">
        <div class="container">
            <ul class="nav page-navigation">
              ...
              <li class="nav-item">
                  <a href="<?php echo base_url('assets/admin');?>/pages/forms/basic_elements.html" class="nav-link">
              ...
              <li class="nav-item">
                  <a href="<?php echo base_url('assets/admin');?>/pages/charts/chartjs.html" class="nav-link">
              ...
              <li class="nav-item">
                  <a href="<?php echo base_url('assets/admin');?>/pages/tables/basic-table.html" class="nav-link">
              ...
              <li class="nav-item">
                  <a href="<?php echo base_url('assets/admin');?>/pages/icons/mdi.html" class="nav-link">
              ...
              <li class="nav-item">
                  <a href="<?php echo base_url('assets/admin');?>/docs/documentation.html" class="nav-link">
    ...
    <script src="<?php echo base_url('assets/admin');?>/vendors/chartjs-plugin-datalabels/chartjs-plugin-datalabels.js"></script>
    <script src="<?php echo base_url('assets/admin');?>/vendors/justgage/raphael-2.1.4.min.js"></script>
    <script src="<?php echo base_url('assets/admin');?>/vendors/justgage/justgage.js"></script>
